...
function myErrorHandler($errno, $errstr, $errfile, $errline)
{
   if (!(error_reporting() & $errno)) {
    ...
    switch ($errno) {
    case E_USER_ERROR:
        echo "<br /><b>Mon ERREUR</b> [$errno] $errstr<br />\n";
    ...
    case E_USER_WARNING:
        echo "<br /><b>Mon ALERTE</b> [$errno] $errstr<br />\n";
        break;

    case E_USER_NOTICE:
        echo "<br /><b>Mon AVERTISSEMENT</b> [$errno] $errstr<br />\n";
        break;

    default:
        echo "<br />Type d'erreur inconnu : [$errno] $errstr<br />\n";
        break;
    }
